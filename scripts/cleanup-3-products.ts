...
/**
 * Script pour supprimer les anciennes sections de 3 produits HIFUTURE
 * Sonic Air, Sonify, OlymBuds 3
 */

async function cleanup3Products() {
  console.log('🧹 Nettoyage des sections pour 3 produits HIFUTURE\n');
  console.log('================================================\n');
  ...
  console.log('\n================================================');
  console.log(`✅ Nettoyage terminé pour 3 produits!`);
  console.log('\n💡 Maintenant, lancez:');
  console.log('   npx tsx scripts/enrich-only-3-products.ts\n');
}
