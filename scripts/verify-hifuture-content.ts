...
/**
 * Vérifie le contenu des produits HIFUTURE enrichis
 */
async function verifyHifutureContent() {
  console.log('🔍 Vérification du contenu des produits HIFUTURE\n');
  console.log('================================================\n');

  // Produits HIFUTURE représentatifs avec générateurs spécifiques
  const keyProducts = [
    'FLYBUDS 4',
    'TOUR X',
    'YACHT',
