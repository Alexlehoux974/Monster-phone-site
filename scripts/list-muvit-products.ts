...
async function listMuvitProducts() {
  console.log('🔍 PRODUITS MUVIT DANS SUPABASE\n');
  ...
  if (!products || products.length === 0) {
    console.log('❌ Aucun produit MUVIT actif trouvé');
    return;
  }

  console.log(`📦 ${products.length} produits MUVIT actifs:\n`);
  ...
  console.log(`\n   📦 Total: ${products.length} produits MUVIT\n`);
}
