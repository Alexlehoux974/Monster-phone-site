...
export const allProducts: Product[] = [
  ...
  // HONOR X6B 6+6/128
  {
    ...
    specifications: [
      ...
      { label: 'Écran', value: '6.67" Full HD+ 90Hz', icon: 'display' },
    ...
    highlights: [
      'Écran 90Hz certifié TÜV Rheinland',
      'Caméra 50MP avec IA',
  ...
  // HONOR X7C 8+6/256
  {
    ...
    discount: 18,
    description: "Le HONOR X7C représente l'excellence du haut de gamme accessible, combinant puissance de traitement et élégance dans un smartphone conçu pour les utilisateurs exigeants. Propulsé par 8GB de RAM physique extensible jusqu'à 16GB via la technologie HONOR RAM Turbo, il offre des performances professionnelles pour gérer applications complexes, montage photo/vidéo mobile et gaming intensif sans ralentissement. Le stockage spacieux de 256GB libère votre potentiel créatif : conservez des milliers de photos haute résolution, heures de vidéos 4K et bibliothèque d'applications complète. L'écran AMOLED de 6.7 pouces avec taux de rafraîchissement 120Hz délivre une expérience visuelle premium : transitions soyeuses, couleurs éclatantes avec gamut DCI-P3 100%, contrastes infinis pour un rendu cinématographique. Luminosité pic 1200 nits pour utilisation confortable en plein soleil tropical. Triple système caméra avec IA avancée : capteur principal 64MP avec OIS pour photos nettes, ultra grand-angle 120° pour paysages époustouflants, macro 5MP pour détails minutieux. Enregistrement vidéo 4K avec stabilisation électronique EIS. Autonomie remarquable avec batterie 5400mAh intelligent Power Management, charge turbo 40W (70% en 30 minutes). Design premium unibody avec finitions métalliques disponibles en 3 coloris exclusifs : Noir Cosmos pour l'élégance intemporelle, Vert Aurora pour la sophistication naturelle et Or Champagne pour le raffinement luxueux. Certification SGS 5 étoiles pour robustesse exceptionnelle, protection IP64 contre poussière et éclaboussures, capteur d'empreinte latéral ultra-rapide, NFC pour paiements sans contact. Le smartphone puissant pour utilisateurs exigeants à La Réunion.",
    shortDescription: 'Smartphone haut de gamme avec écran AMOLED 120Hz, IP64 et certification SGS 5 étoiles',
    metaTitle: 'HONOR X7C 8+8/256GB - Smartphone Haut de Gamme AMOLED 120Hz IP64 | Monster Phone 974',
    metaDescription: 'HONOR X7C haut de gamme : 8+8GB RAM, 256GB, AMOLED 120Hz, triple caméra 64MP OIS, IP64, SGS 5 étoiles. Monster Phone La Réunion 974.',
    ...
    specifications: [
      ...
      { label: 'Protection', value: 'IP64', icon: 'shield' },
      { label: 'Certification', value: 'SGS 5 étoiles', icon: 'certificate' }
    ],
    highlights: [
      'Écran AMOLED 120Hz DCI-P3',
      'Triple caméra 64MP avec OIS',
      'RAM extensible jusqu\'à 16GB',
      'Certification SGS 5 étoiles',
      'Protection IP64'
    ],
    images: [
      'https://raw.githubusercontent.com/Alexlehoux974/Monster-Phone-Images/main/HONOR/Smartphones/honor-x7c-noir-1.jpg',
