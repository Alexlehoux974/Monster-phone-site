...
export const metadata: Metadata = {
  ...
  description: 'Smartphones HONOR à La Réunion : X9C, X7C, X6C, X5B. Livraison express 24/48h, garantie 2 ans. Pack complet avec chargeur et protection vitre offerts.',
};
