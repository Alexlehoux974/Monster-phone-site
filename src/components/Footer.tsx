        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/nos-produits" className="text-gray-300 hover:text-white transition-colors">Tous nos produits</Link></li>
              <li><Link href="/nos-produits?category=Smartphones" className="text-gray-300 hover:text-white transition-colors">Smartphones</Link></li>
              <li><Link href="/accessoires" className="text-gray-300 hover:text-white transition-colors">Accessoires</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Livraison gratuite dès 50€</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Retours sous 30 jours</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Garantie constructeur</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Service après-vente</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Support technique</a></li>
            </ul>
          </div>

          {/* Contact & Légal */}
          <div>
            <h3 className="font-semibold text-lg mb-4">Contact & Légal</h3>
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Plan du site</a></li>
            </ul>
          </div>
        </div>
      </div>
