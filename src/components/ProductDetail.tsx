    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
          ...
          <ChevronRight className="h-4 w-4 text-gray-400" />
          <Link href={{'Smartphones': '/smartphones', 'Tablettes': '/tablettes', 'Audio': '/audio', 'Montres': '/montres', 'LED': '/led', 'Accessoires': '/accessoires'}[product.categoryName] || `/nos-produits?category=${encodeURIComponent(product.categoryName)}`} className="hover:text-red-600 transition-colors">{product.categoryName}</Link>
          <ChevronRight className="h-4 w-4 text-gray-400" />
