...
export function getGoogleProductCategory(categoryName: string): string {
  const categoryMap: Record<string, string> = {
    ...
    'Smartphones Gaming': 'Electronics > Communications > Telephony > Mobile Phones',
    'Smartphones 5G': 'Electronics > Communications > Telephony > Mobile Phones',
    'Téléphones': 'Electronics > Communications > Telephony > Mobile Phones',
    'Téléphones Classiques': 'Electronics > Communications > Telephony > Mobile Phones',
    'Accessoires': 'Electronics > Electronics Accessories',
    'Divers': 'Electronics > Electronics Accessories',
    ...
    'Gaming Audio': 'Electronics > Audio > Headphones & Earbuds',
    'Micro': 'Electronics > Audio > Audio Accessories > Microphones',
    'Montres': 'Electronics > Wearable Technology > Smartwatches',
    'Montres Connectées': 'Electronics > Wearable Technology > Smartwatches',
    'Montres Sport': 'Electronics > Wearable Technology > Smartwatches',
    ...
    'Batteries externes': 'Electronics > Electronics Accessories > Power Accessories > Power Banks',
    ...
    'Tablettes': 'Electronics > Computers > Tablet Computers',
    'Tablettes Gaming': 'Electronics > Computers > Tablet Computers',
    'LED': 'Home & Garden > Lighting > Light Bulbs',
    'Barre LED': 'Home & Garden > Lighting > Light Bulbs',
    'Néon': 'Home & Garden > Lighting > Light Bulbs',
    'Ampoules': 'Home & Garden > Lighting > Light Bulbs',
    'RGB': 'Home & Garden > Lighting > Light Bulbs',
    'Cables Lumineux': 'Home & Garden > Lighting > Light Bulbs',
    'Kits Éclairage': 'Home & Garden > Lighting',
    'Appareils Photo': 'Cameras & Optics > Cameras > Digital Cameras',
    'Accessoires Photo': 'Cameras & Optics > Camera & Optic Accessories',
  };
